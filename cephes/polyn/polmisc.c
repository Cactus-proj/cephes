 ...
 */
double patan[N + 1] = {0.0,       1.0, 0.0,         -1.0 / 3.0, 0.0,        1.0 / 5.0, 0.0,         -1.0 / 7.0, 0.0,
                       1.0 / 9.0, 0.0, -1.0 / 11.0, 0.0,        1.0 / 13.0, 0.0,       -1.0 / 15.0, 0.0};
 ...
 */
void polatn(num, den, ans, nn) double num[], den[], ans[];
int nn;
{
    double a, t;
 ...
 */
void polsqt(pol, ans, nn) double pol[], ans[];
int nn;
{
    double t;
    double *x, *y;
