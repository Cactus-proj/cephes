...
/* c = b * a.
 */
void polmul(a, na, b, nb, c) fract a[], b[], c[];
int na, nb;
{
    int i, j, k, nc;
    fract temp;
...
/* c = b + a.
 */
void poladd(a, na, b, nb, c) fract a[], b[], c[];
int na, nb;
{
    int i, n;
...
/* c = b - a.
 */
void polsub(a, na, b, nb, c) fract a[], b[], c[];
int na, nb;
{
    int i, n;
...
void polsbt(a, na, b, nb, c) fract a[], b[], c[];
int na, nb;
{
    int i, j, k, n2;
    fract temp;
